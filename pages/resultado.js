...
export default function Resultado() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-100">
      <div className="max-w-5xl flex items-center lg:h-screen flex-wrap  mx-auto lg:my-0">
        ...
        {/* <!--Main Col--> */}
        <div  className="ml-4 mr-4 py-4 px-8  mt-1 lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl text-center 
        bg-white opacity-75 lg:mx-0">
          <div className="p-4 md:p-12 text-center lg:text-left ">
            ...
            <div className=" ">
              <table className="table-responsive ml-auto mr-auto text-center mb-2 lg:w-4/5 rounded">
                ...
                <tbody>
                  ...
                  <tr className={ lead.result == 3 ? "imcSelect" : "bg-white"}>
            ...
            <p className="font-size-resultado-veja-abaixo text-justify ">Veja como perder gordura e ganhar massa abaixo: </p>
        ...
        <div className="w-full p-4 mr-4 ml-4 lg:w-2/5 rounded-lg  lg:rounded-l-lg lg:rounded-r-none shadow-3xl bg-gray-200 opacity-75 mx-6 lg:mx-0">
          ...
          <p className="font-size-resultado text-justify font-bold">Manter o IMC dentro da classificação ideal, é de extrema importância pois previne doenças como diabetes, colesterol, problemas cardíacos, gordura no fígado, câncer entre outros. Por isso é muito importante fazer exames regularmente e manter uma alimentação saudável.</p><br></br>
          <p className="font-size-resultado text-justify font-bold">A medfit conta com um processo de emagrecimento com acompanhamento de médicos, e nutricionistas onde você realiza todos os exames clínicos sem pagar nada por isso. Tudo utilizando seu convênio via reembolso.</p>
  ...
  <span className="font-size-resultado text-justify font-bold ">Clique no botão abaixo e descubra como você pode emagrecer de 5 a 10kg nas próximas semanas com nosso acompanhamento</span>
          <div className="w-full flex mr-auto ml-auto mt-5">
