...
export default function Resultado() {
  ...
  return (
    <div className="h-full w-full bg-gradient-to-r from-blue-100 ">
      <div className="items-center flex flex-wrap">
        <div className="w-full md:w-5/12 items-center ml-auto mr-auto ">
          <div className="pr-12 border-solid border-gray-900">
            <div className="p-4 text-center inline-flex items-center justify-center w-64 mb-1 shadow-sm rounded-sm">
        ...
        <div className="w-full lg:w-2/5 p-5 rounded-lg lg:rounded-l-lg lg:rounded-r-none opacity-75 ml-auto mr-auto ">
          <div className="p-1 text-center lg:text-left">                     
            <h1 className="text-3xl font-bold ">{lead.nome}, o seu IMC é: {lead.imc}</h1>
            ...
            <div className="flex flex-wrap">
              ...
              <table className="table-responsive  text-center w-full rounded">
                <thead>
                  <tr>                  
            ...
            <div className="mt-6 lg:pb-0  lg:w-full flex flex-wrap items-center">
              <p className="text-md text-left font-medium mt-3">Manter o imc dentro da classificação ideal, é de extrema importância pois previne doenças como diabetes, colesterol, problemas cardíacos, gordura no fígado, câncer entre outros. por isso é muito importante fazer exames regularmente e manter uma alimentação saudável.
              </p><br></br>
              <p className="text-md text-left  font-medium">A medfit conta com um processo de emagrecimento com acompanhamento de médicos, e nutricionistas onde você realiza todos os exames clínicos sem pagar nada por isso. tudo utilizando seu convênio via reembolso.
              ...
              <div className="w-full flex justify-end mt-10">
                <button className=" bg-green-300 font-bold 
                  px-6 py-1 rounded shadow hover:shadow-lg outline-none focus:outline-none 
                  transition-all duration-120"  type="button" onClick={back}><a className="link" target="_blank" href="https://www.instagram.com/medfitclinica/" data-tippy-content="@instagram_handle">
                    {/* <a href="https://api.whatsapp.com/send?phone=51955081075&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20Varela%202." class="float" target="_blank"> */}
                      <span className={"align-middle inline-flex items-center"}>
                      Conversar 
                      <svg className="h-6 m-3 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24" class="fill-current h-4 text-brand hover:text-teal" xmlns="http://www.w3.org/2000/svg">
