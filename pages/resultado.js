  ...
  return (
    <div className="bg-gradient-to-r from-blue-100">
      <div className="max-w-5xl flex items-center lg:h-screen flex-wrap  mx-auto lg:my-0">
        ...
        {/* <!--Main Col--> */}
        <div  className="ml-4 mr-4 py-4 px-8  mt-5 lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl text-center 
          ...
          <div className="w-full flex  mt-5">
            <div className="w-full text-white flex justify-start">
              <a href="https://api.whatsapp.com/send?phone=5511972330763&text=Olá%21%20medfit"
                ...
                <button className=" bg-whatsapp-color hover:text-green-700 text-white font-bold py-1 px-3 rounded inline-flex items-center">
